...
import { collectPackageAssets } from "./collector.js";
import { normalizePackage } from "./normalizer.js";
import { mapDeterministically } from "./mapper/deterministicMapper.js";
import { mapWithLlmProtocol } from "./mapper/llmProtocolMapper.js";
import { buildEvaluationPack, validateEvaluationPack } from "./validator.js";
...
function buildReportMarkdown(options, warnings, validation) {
    const lines = [];
...
export async function convertGameEnginePackage(options) {
